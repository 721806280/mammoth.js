...
function Numbering(nums, abstractNums, styles) {
    ...
    function findLevelWithSeenNumIds(numId, level, seenNumIds) {
        ...
        if (!abstractNum) {
            ...
            levelDefinitions = numberingLevel ? numberingLevel.levelDefinitions : Object.create(null);
        }

        if (numberingLevel == null) {
            return null;
        } else {
            return _.extend({}, numberingLevel, (num.levelOverrides || Object.create(null))[level], {
                levelDefinitions: levelDefinitions,
                numId: numId
            });
        }
    ...
    function levelDefinitionsForNum(num, abstractNum) {
        var levelDefinitions = Object.create(null);
        var levelOverrides = num.levelOverrides || Object.create(null);
...
function readLevelOverrides(element) {
    var levelOverrides = Object.create(null);
